...
class ServiceUtilitaires {
	...
	public function analyseAccess($sitesOuModules) 
	{
		...
		foreach ($tab_entities_site as $entity_site) {
			...
			switch ($sitesOuModules) {
				case 'sites':
					if (substr(strtoupper($entity_site->getAffaire()),0,1) != 'M')
					{
						// Si on doit analyser un site est que l'on est face à un site qui n'est pas dans la liste des ewons non suivis
				...
				case 'modules':
					if (substr(strtoupper($entity_site->getAffaire()),0,1) == 'M')
					{
						// Si on doit analyser un module est que l'on est face à un module qui n'est pas dans la liste des ewons non suivis
	...
	public function getEwonStatusBoilerBox($entity_site)
	{
		if($entity_site->getSiteConnexion())
		{
            ...
            if (!array_key_exists($affaire_url, $this->ewons))
			{
                ...
                if ($this->debug) { echo "\n"; print_r($this->ewons[$affaire_url]); echo "\n"; echo "\n"; }
    ...
    */
	...
	public function gestion_mail_connexion_erreur($erreur, $ent_site)
	{
		...
		{	// Gestion des mails d'erreur
			if ( (in_array($erreur, ['ip', 'ping', 'pageHtml'])) && ($ent_site->getMailSended() == 'non') ) 
			{	// Si perte de connexion depuis boiler-box.fr et qu'aucun autre mails d'erreur de connexion n'a été envoyé : On envoi le mail de perte de connexion boiler-box.fr
			...
			} else if (in_array($erreur, ['talk2m', 'offline']))
			{	// Si perte de connexion de l'ewon avec les serveurs de talk2m et qu'aucun autre mail d'erreur de connexion talk2m n'a été envoyé : On envoi le mail de perte de connexion vers les serveurs talk2m
	...
	private function sendMail($type, $ent_site)
	{
		...
		switch ($type) 
		{
            case 'erreur_script_access_succeded' :
                ...
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>La date d\'accès à distance en succés : '.$this->variable_en_erreur.' est définie à aujourd\'hui - Elle devrait être définie à j-1.</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
			...
			case 'erreur_script_today' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>La date d\'echec de connexion à distance est définie à aujourd\'hui - Elle devrait être définie à j-1.</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
			...
			case 'erreur_script_diff' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>Une durée d\'indisponibilité est rencontrée mais le site indique 0 erreur de connexion VPN.</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
            ...
            case 'erreur_script_diffBB' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>Une durée d\'indisponibilité est rencontrée mais le site indique 0 erreur de connexion BoilerBox.</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
			...
			case 'fin_alerte_netcat_plus' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>Les connexions avec le site '.$ent_site->getIntitule().' ('.$ent_site->getAffaire().') ont été rétablies</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
			...
			case 'fin_alerte_netcat' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>La connexion depuis boiler-box.fr avec le site '.$ent_site->getIntitule().' ('.$ent_site->getAffaire().') a été rétablie</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
		...
		case 'fin_alerte_ewon' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>La connexion depuis eCatcher vers l\'ewon du site '.$ent_site->getIntitule().' ('.$ent_site->getAffaire().') a été rétablie</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
		...
		case 'alerte_netcat' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>La connexion depuis boiler-box.fr vers le site '.$ent_site->getIntitule().' ('.$ent_site->getAffaire().') a été perdue</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
			...
			case 'alerte_ewon' :
                ...
                $tab_message['affaire'] = $ent_site->getAffaire();
                $tab_message['message'] = array();
                array_push($tab_message['message'], '<b style=\'font-size:20px;\'>La connexion depuis eCatcher vers l\'ewon du site '.$ent_site->getIntitule().' ('.$ent_site->getAffaire().') a été perdue</b>');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], '');
                array_push($tab_message['message'], 'Cordialement,');
                array_push($tab_message['message'], 'Assistance IBC');
						...
						if ( (($entity_site->getSiteConnexion()->getNbEchecConnexionJournalier() != 0) || ($entity_site->getSiteConnexion()->getNbEchecConnexionJournalierBB() != 0)) && ($entity_site->getErreurScript() == null) )
						{
							...
							{	
								...
								if ($this->debug) 
								{
									...
									echo "delais d'echec trop faible pour le site ".$entity_site->getAffaire()."\n";
								}
